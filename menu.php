		...
		<div class="header2">
			...
			<div class="akunIcon">
				<div class="containerIcon">
					...
					<a href="logout.php" class="text-light text-right"><i class='fas fa-sign-out-alt'></i></a>
				</div>
			</div>
		</div>
	</header>
		...
		<div id="myDIV" class="ringMenu">
			<ul class="containerList">
				...
				<li class="two material-icons md-48 md-dark"
					onclick="changedH1('Cryotography');changedColorText('#013499');changedColor('#98DAE9');changedP('Solve The Problem And Find flag!');changedButton('#017E99');changedLink('#Cryptography')">
					https</li>
				<li class="three material-icons md-48 md-dark"
					onclick="changedH1('Forensik');changedColorText('#C7771A');changedColor('#E8D8C7');changedP('Solve The Problem And Find flag!');changedButton('#C7771A');changedLink('#Forensik')">
					fingerprint</li>
